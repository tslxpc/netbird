...
replace github.com/dexidp/dex => github.com/netbirdio/dex v0.244.1-0.20260408094514-ca1fe7cd65e3

replace github.com/dexidp/dex/api/v2 => github.com/netbirdio/dex/api/v2 v2.0.0-20260408094514-ca1fe7cd65e3
